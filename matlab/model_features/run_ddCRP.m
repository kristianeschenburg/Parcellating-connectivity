...
function run_ddCRP(surfacefile, labelfile, datafile, outputfile, ... 
    ...
    clear D data adjacency_list labelmap label 
    


    %%% %%% Run ddCRP %%% %%%

    [~,Z] = WardClustering(D_norm,filtered_adjacency,sizes);
    [map_z, stats] = InitializeAndRunddCRP(Z, D_norm, features, adj_list, ...
                    sizes, alpha, kappa, nu, sigsq, ...
                    pass_limit, [], true)
